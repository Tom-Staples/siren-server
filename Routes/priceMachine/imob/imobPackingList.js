...
const imobConversion = require('./imobConversion');
const writeFile = require('../writeFile');

const imobPackingList = async (req, res, path) => {
  try {
    ...
    const result = await imobConversion(data);
...
module.exports = imobPackingList;
